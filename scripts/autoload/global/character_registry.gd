...
@export var AllPlantFusion:Dictionary[Vector2i, PlantType] = {
	Vector2i(PlantType.P002SunFlower, PlantType.P001PeaShooterSingle): PlantType.P100SunPea,
	Vector2i(PlantType.P001PeaShooterSingle, PlantType.P002SunFlower): PlantType.P100SunPea, ## 反过来种也能融合
	
	Vector2i(PlantType.P001PeaShooterSingle, PlantType.P039MariGold): PlantType.P101CoinPea,
	Vector2i(PlantType.P039MariGold, PlantType.P001PeaShooterSingle): PlantType.P101CoinPea,
}

func get_fusion_result(existing_plant_type:PlantType, incoming_plant_type:PlantType) -> PlantType:
	var key := Vector2i(existing_plant_type, incoming_plant_type)
	if AllPlantFusion.has(key):
		return AllPlantFusion[key]
...
const PlantInfo = {
	...
	PlantType.P050Niejo: {
	PlantInfoAttribute.PlantName: "Niejo",
	PlantInfoAttribute.CoolTime: 7.5,
	PlantInfoAttribute.SunCost: 100,
	PlantInfoAttribute.PlantConditionResource: preload("res://resources/character_resource/plant_condition/050_niejo.tres"),
	...
	PlantType.P100SunPea: {
		PlantInfoAttribute.PlantName: "SunPea",
		PlantInfoAttribute.CoolTime: 7.5,
		PlantInfoAttribute.SunCost: 175,
		PlantInfoAttribute.PlantConditionResource : preload("res://resources/character_resource/plant_condition/000_common_plant_land.tres"),
		PlantInfoAttribute.PlantScenes : preload("res://scenes/character/plant/plant_100_sun_pea.tscn")
		},
	PlantType.P101CoinPea: {
		PlantInfoAttribute.PlantName: "CoinPea",
		PlantInfoAttribute.CoolTime: 7.5,
		PlantInfoAttribute.SunCost: 175,
		PlantInfoAttribute.PlantConditionResource : preload("res://resources/character_resource/plant_condition/000_common_plant_land.tres"),
...
const ZombieInfo = {
	...
	ZombieType.Z026RedEyeGargantuar:{
		ZombieInfoAttribute.ZombieName: "ZombieRedEyeGargantuar",
		ZombieInfoAttribute.CoolTime: 0.0,
		ZombieInfoAttribute.SunCost: 300,
		ZombieInfoAttribute.ZombieScenes:preload("res://scenes/character/zombie/zombie_026_red_eye_gargantuar.tscn"),
		ZombieInfoAttribute.ZombieRowType:CharacterRegistry.ZombieRowType.Land
	},
	## 单独雪橇僵尸
